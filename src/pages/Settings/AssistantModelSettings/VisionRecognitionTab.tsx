...
const VisionRecognitionTab: React.FC = () => {
  ...
  const handlePresetModelSelect = (model: ModelWithProvider) => {
    dispatch(
      setVisionPresetModelRef({
        providerId: model.providerId || (model as any).provider,
        modelId: model.id,
      })
    );
    setTestResult(null);
...
export default VisionRecognitionTab;
